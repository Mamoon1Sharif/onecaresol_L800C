...
import { Search, Plus, Phone, Heart, CalendarDays } from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Manage service members · {careReceivers.length} total
            </p>
          </div>
                    ...
                    <div className="p-5 flex-1">
                      ...
                      <div className="flex flex-col items-center text-center mb-4">
                        <div className="h-24 w-24 rounded-full border-2 border-border overflow-hidden mb-3">
                          <img
                            src={getCareReceiverAvatar(cr.id, cr.avatar_url)}
                            alt={cr.name}
